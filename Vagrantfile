...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "develop.local.dev"

  config.vm.network :private_network, ip: "10.100.198.102" 
  ...
  config.vm.provision 'shell', inline: 'sudo apt install  curl wget jq unzip -y'
